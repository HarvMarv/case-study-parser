...
/** The parse succeeded.
  *
  * \- result is the parsed value \- input is the input that was parsed \-
...
/** The parse failed.
  *
  * \- reason is a description of why the parser failed \- input is the input
  * that the parser attempted to parse \- start is the index into input of where
